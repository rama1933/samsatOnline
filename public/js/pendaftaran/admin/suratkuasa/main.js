...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/admin/pendaftaran/suratkuasaadmin/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/pendaftaran/suratkuasaadmin/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/pendaftaran/suratkuasaadmin/delete',
                    method: "POST",
