...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/admin/pendaftaran/pendaftaranfisik/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/admin/pendaftaran/pendaftaranfisik/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/admin/pendaftaran/pendaftaranfisik/delete',
                    method: "POST",
