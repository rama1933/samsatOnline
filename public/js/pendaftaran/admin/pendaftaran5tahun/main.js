...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/admin/pendaftaran/pendaftaran5tahun/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/admin/pendaftaran/pendaftaran5tahun/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/admin/pendaftaran/pendaftaran5tahun/delete',
                    method: "POST",
