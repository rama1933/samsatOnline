...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/admin/pendaftaran/pendaftaranduplikat/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/admin/pendaftaran/pendaftaranduplikat/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/admin/pendaftaran/pendaftaranduplikat/delete',
                    method: "POST",
