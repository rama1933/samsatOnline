...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/admin/pendaftaran/pendaftaranbalik/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
            ...
            {
                data: 'download_kwitansi_pembelian',
                name: 'download_kwitansi_pembelian'
            },
            {
                data: 'status',
                name: 'status'
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/admin/pendaftaran/pendaftaranbalik/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/admin/pendaftaran/pendaftaranbalik/delete',
                    method: "POST",
