...
function datatable() {
    ...
    $('#table').DataTable({
        ...
        ajax: window.location.origin + '/pendaftaran/pendaftarankuasa/data',
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
function edit(id) {
    $.ajax({
        url: window.location.origin + '/pendaftaran/pendaftarankuasa/show',
        method: "GET",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: window.location.origin + '/pendaftaran/pendaftarankuasa/delete',
                    method: "POST",
