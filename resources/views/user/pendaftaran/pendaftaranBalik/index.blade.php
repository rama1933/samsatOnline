...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.balik') }}" target="_blank" title="Unduh Dokumen (PDF)"
...
@include('user.pendaftaran.pendaftaranbalik.form')
@endsection
...
<script src="{{asset('js/pendaftaran/user/pendaftaranbalik/main.js')}}"></script>
@endsection
