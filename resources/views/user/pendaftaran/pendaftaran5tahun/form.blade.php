    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-create" action="{{ route('pendaftaran5tahun.store') }}" enctype="multipart/form-data">
                    @csrf
...
<div class="modal fade" role="dialog" id="modal-edit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-edit" action="{{ route('pendaftaran5tahun.update') }}" enctype="multipart/form-data">
                    @csrf
