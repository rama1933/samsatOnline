...
<div class="card">
    <div class="card-header" style="background-color: rgb(241, 241, 241)">
        <div class="row">
            <div class="col-6">
                <h4 class="card-title"> TABEL PENDAFTARAN 5 TAHUN</h4>
            </div>
            <div class="col-6">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.5tahun') }}" target="_blank" title="Unduh Dokumen (PDF)" class="btn btn-md btn-success mb-3"><i
...
@include('user.pendaftaran.pendaftaran5tahun.form')
@endsection
...
<script src="{{asset('js/pendaftaran/user/pendaftaran5tahun/main.js')}}"></script>
@endsection
