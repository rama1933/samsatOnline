...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.duplikat') }}" target="_blank" title="Unduh Dokumen (PDF)"
...
@include('user.pendaftaran.pendaftaranduplikat.form')
@endsection
...
<script src="{{asset('js/pendaftaran/user/pendaftaranduplikat/main.js')}}"></script>
@endsection
