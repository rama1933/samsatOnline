                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="{{route('pdf.1tahun')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('pdf.5tahun')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="{{route('pdf.kuasa')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="{{route('pdf.duplikat')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="{{route('pdf.balik')}}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                        <tr>
                        <td>
                        ...
                        <td><a href="{{ route('pdf.biodatadetail',auth()->user()->biodata_id) }}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i></a>
                        </td>
                        </tr>
                    </tbody>
                </table>
