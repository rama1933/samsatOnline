    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-create" action="{{ route('pendaftaranbalik.store') }}" enctype="multipart/form-data">
                    @csrf
                   ...
                   <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            <label for="no_rangka_upload">Upload No Rangka halaman</label>
                            <input type="file" class="form-control" name="no_rangka_upload" required />
                        </div>

                        <div class="form-group col-lg-12">
                            <label for="no_mesin_upload">Upload No Mesin halaman</label>
                            <input type="file" class="form-control" name="no_mesin_upload" required />
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="file" class="form-control" name="kwitansi_pembelian" required />
                        </div>
                    </div>
            </div>
...
<div class="modal fade" role="dialog" id="modal-edit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-edit" action="{{ route('pendaftaranbalik.update') }}" enctype="multipart/form-data">
                    @csrf
