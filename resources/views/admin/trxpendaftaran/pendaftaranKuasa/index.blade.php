...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.kuasaadmin') }}" target="_blank" title="Unduh Dokumen (PDF)"
...
@include('admin.trxpendaftaran.pendaftarankuasa.form')
@endsection
...
<script src="{{asset('js/pendaftaran/admin/pendaftarankuasa/main.js')}}"></script>
@endsection
