...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.5tahunadmin') }}" target="_blank" title="Unduh Dokumen (PDF)"
...
@include('admin.trxpendaftaran.pendaftaran5tahun.form')
@endsection
...
<script src="{{asset('js/pendaftaran/admin/pendaftaran5tahun/main.js')}}"></script>
@endsection
