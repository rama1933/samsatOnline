...
<div class="card">
    <div class="card-header" style="background-color: rgb(241, 241, 241)">
        <div class="row">
            <div class="col-6">
                <h4 class="card-title"> TABEL PENDAFTARAN DUPLIKAT</h4>
            </div>
            <div class="col-6">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('pdf.duplikatadmin') }}" target="_blank" title="Unduh Dokumen (PDF)"
...
@include('admin.trxpendaftaran.pendaftaranduplikat.form')
@endsection
...
<script src="{{asset('js/pendaftaran/admin/pendaftaranduplikat/main.js')}}"></script>
@endsection
