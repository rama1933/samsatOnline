...
class PendaftaranService
{
    ...
    public static function storePendafataran1tahunonline(array $data)
    {

        $repo = new UploadRepository();
        $upload = $repo->uploadpendaftaran1tahun($data['ktp'], $data['pajak'], $data['stnk'], $data['bpkb']);

        $pendaftaran = Pendaftaran1tahunonline::create([
            "user_id" => $data['user_id'],
            "biodata_id" => $data['biodata_id'],
            "nopol" => $data['nopol'],
            "tempat" => $data['tempat'],
    ...
    public static function updatePendaftaran1tahunonline($id, array $data)
    {
    ...
    public static function deleteDataPendaftaran1tahunonline($id)
    {
        try {
            Pendaftaran1tahunonline::find($id)->delete();
            return true;
        } catch (\Throwable $th) {
            return false;
        }
